...
| `route_switcher.table_changed` | Изменение next hop в таблице маршрутизации | `0` - отсутствуют изменения<br>`1` - выполнены изменения<br>`2` - возникла ошибка при выполнении изменений | `route_switcher_id` - id функции route-switcher<br>`route_table_id` - id таблицы маршрутизации |
